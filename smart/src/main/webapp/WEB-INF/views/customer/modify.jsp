...
<h3>고객정보수정</h3>
	...
	<input type='hidden' name ='id' value='${vo.id}'>
		...
		<tr>
			...
			<td><input type ='radio' value ='남' name ='gender' <c:if test ='${vo.gender eq "남"}'>checked</c:if>>남
			<input type ='radio' value ='여' name ='gender' <c:if test ='${vo.gender eq "여"}'>checked</c:if> >여 </td>
		</tr>
		<tr>
			<th class ='w-px140'>연락처</th>
